    ...
    >
      ...
      <div class="relative bg-white p-5 pb-12 pt-[60px] shadow lg:px-8 lg:py-12">
        ...
        <section class="mb-[46px] lg:mb-12">
          <h3 class="mb-3.5 flex justify-center gap-2">
            <span class="text-h4">{{ props.detail?.text }}</span>
          </h3>
        </section>
        <!-- Modal footer -->
        <section class="text-center">
          <button type="button" class="btn btn-primary px-12" @click="closeModal()">關閉</button>
        </section>
      </div>
    </div>
  </div>
