...
<template>
  ...
  <section class="bg-light-emphasis lg:bg-transparent">
    <div class="container gap-6 lg:flex">
      <div class="mb-12 bg-light-emphasis pt-12 lg:mb-0 lg:w-1/2 lg:p-12 lg:pb-20">
        <div class="mb-6 flex items-center gap-2">
          <span><img src="~/assets/images/icons/bars.svg" alt="信用卡" class="w-10" /></span>
          <h2>訂單資料</h2>
        </div>
      ...
      <div class="-mx-3 mb-16 border-grey-200 lg:mx-auto lg:w-1/2">
        <CardBlockCarrot
          :title="'感謝您的贊助'"
          :text="'^.^'"
          :btn="'查看贊助紀錄'"
